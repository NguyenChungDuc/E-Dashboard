...
import chuky from "../Assets/chu ky.png";
      ...
      <div className="chef">
        <div className="infomation_chef">
          ...
          <div className="icon">
            ...
            <StarIcon className="star" />
            <StarIcon className="star star-big" />
            <StarIcon className="star" />
            <StarIcon className="star" />
          </div>
          <p>
            Gordon James Ramsay is a famous Scottish chef, restaurateur and
            television star. Ramsay's restaurant chain has been awarded 14
            Michelin stars, the symbol of the world's best restaurants. Gordon
            Ramsay is honored as the most influential figure in the
            accommodation and food industry of the country. United Kingdom in
            2009, became the most powerful restaurant and hotel owner voted by
